"""
Django settings for kbcbdj_18 project.
...
WSGI_APPLICATION = 'kbcbdj_18.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kbcbdj_18 API",
    "DESCRIPTION": "API documentation for kbcbdj_18 App",
    "VERSION": "v1",
}
